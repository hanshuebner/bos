...
function last_sponsors(sponsors)
{
    ...
    replaceChildNodes('Info3Text',
		      ...
		      msg('Anzahl verkaufte mÂ²'), BR(),
		      B(anzahlVerkauft), BR(), BR(),
		      msg('Letzter Sponsor'), BR(),
		      B(sponsor.name, BR()),
		      '(' + sponsor.date.getDate() + "." + (sponsor.date.getMonth() + 1) + "." + ' - ' + sponsor.country + ' - ' + sponsor.count + ' mÂ²)');
}
...
function show_poi_movie() {
	...
	document.getElementById("PoiInfoText").innerHTML
	    = msg('Das Laden des Videos dauert einen Moment und benÃ¶tigt Flash in Ihrem Browser.');
